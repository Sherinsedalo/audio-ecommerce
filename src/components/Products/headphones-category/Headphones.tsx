            ...
            <section className="bg-white">
                <div className="flex flex-col items-center justify-center gap-12 mt-3 font-manrope">
                    ...
                    <div className="flex flex-col items-center text-center px-6 md:px-9 gap-8 md:gap-12 md:py-6 lg:flex-row lg:justify-center lg:items-center lg:max-w-7xl">
                        <img src="/assets/product-xx99-mark-two-headphones/mobile/image-product.jpg" alt="Headphone model" className="rounded-lg w-full max-w-md lg:w-1/2" />
                        <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left gap-6">
                            ...
                            <SeeProductButton to="/headphones/MarkTwoHeadphones" variant="orange" />
                        </div>
                    </div>

                    {/* Mark One Headphones model*/}
                    <div className="flex flex-col items-center text-center px-6 md:px-9 gap-8 md:gap-12 md:py-6 lg:flex-row-reverse lg:justify-center lg:items-center lg:max-w-7xl">
                        <img src="/assets/product-xx99-mark-one-headphones/mobile/image-product.jpg" alt="Headphone model" className="rounded-lg w-full max-w-md lg:w-1/2" />
                        <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left gap-6">
                            <p className="uppercase font-light text-md text-[#D87D4A] tracking-widest">New product</p>
                            ...
                            <SeeProductButton to="/headphones/MarkOneHeadphones" variant="orange" />
                        </div>
                    </div>

                    {/* Third headphones model */}
                    <div className="flex flex-col items-center text-center px-6 md:px-9 gap-8 md:gap-12 md:py-6 lg:flex-row lg:justify-center lg:items-center lg:max-w-7xl">
                        <img src="/assets/product-xx59-headphones/mobile/image-product.jpg" alt="Headphone model" className="rounded-lg w-full max-w-md lg:w-1/2" />
                        <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left gap-6">
                            <p className="uppercase font-light text-md text-[#D87D4A] tracking-widest">New product</p>
                            ...
                            <SeeProductButton to="/headphones/xx59Headphones" variant="orange" />
                        </div>
                    </div>
                </div>
            </section>
