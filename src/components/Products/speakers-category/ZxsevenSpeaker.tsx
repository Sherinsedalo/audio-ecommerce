...
export function ZxSevenSpeaker() {
    ...
    const boxItems: BoxItem[] = [
        ...
        { quantity: '1x', item: "3.5mm 7.5mm audio cable" },
        ...
        <div className="bg-[#F1F1F1] flex flex-col items-left font-manrope ">
            ...
            <div className="flex flex-col items-start text-center px-6 md:px-9 gap-8 md:gap-6 lg:items-center  lg:gap-14">
                <div className="md:flex md:justify-center items-center lg:justify-start lg:items-start lg:max-w-2xl lg:gap-6 lg:px-0">
                    <picture>
                        <source media="(min-width: 1024px)" srcSet="/assets/product-zx7-speaker/desktop/image-product.jpg" />
                        <source media="(min-width: 768px)" srcSet="/assets/product-zx7-speaker/tablet/image-product.jpg" />
                        <img src="/assets/product-zx7-speaker/mobile/image-product.jpg" alt="Headphone model" className="rounded-lg w-full max-w-md md:max-w-full " />
                    ...
                    <div className=" flex flex-col items-left  text-left  lg:text-left gap-6">
                        ...
                        <p className="text-[#878787] leading-6 text-md font-light md:text-xl md:leading-7 max-w-lg lg:text-md md:max-w-full">    Stream high quality sound wirelessly with minimal to no loss. The ZX7 speaker uses high-end
                            audiophile components that represents the top of the line powered speakers for home or studio use.

                        </p>
                        <p className="font-bold tracking-wider">$3,500</p>
                ...
                <div className="lg:w-1/2 flex flex-col items-left lg:items-start text-left  lg:text-left gap-7">
                    ...
                    <p className="text-[#878787] leading-6 text-md font-light md:text-xl md:leading-7 max-w-lg lg:max-w-full lg:text-md lg:leading-8">  Reap the advantages of a flat diaphragm tweeter cone. This provides a fast response rate and
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2  px-6 md:px-9 mb-14 mt-9 max-w-6xl mx-auto md:items-center   ">
                <div className="lg:flex lg:flex-col lg:gap-6  ">
                    <picture >
                        <source media="(min-width: 1024px)" srcSet="/assets/product-zx7-speaker/desktop/image-gallery-1.jpg" />
                        <source media="(min-width: 768px)" srcSet="/assets/product-zx7-speaker/tablet/image-gallery-1.jpg" />
                        <img src="/assets/product-zx7-speaker/mobile/image-gallery-1.jpg" alt="Gallery image 1" className="w-full max-w-md rounded-lg mb-2 md:mb-5 md:mt-14 " />
                    </picture>
                    <picture>
                        <source media="(min-width: 1024px)" srcSet="/assets/product-zx7-speaker/desktop/image-gallery-2.jpg" />
                        <source media="(min-width: 768px)" srcSet="/assets/product-zx7-speaker/tablet/image-gallery-2.jpg" />
                        <img src="/assets/product-zx7-speaker/mobile/image-gallery-2.jpg" alt="Gallery image 2" className="w-full max-w-md rounded-lg" />
                    </picture>
                </div>
                <picture>
                    <source media="(min-width: 1024px)" srcSet="/assets/product-zx7-speaker/desktop/image-gallery-3.jpg" />
                    <source media="(min-width: 768px)" srcSet="/assets/product-zx7-speaker/tablet/image-gallery-3.jpg" />
                    <img src="/assets/product-zx7-speaker/mobile/image-gallery-3.jpg" alt="Gallery image 3" className="w-full max-w-md lg:h-full lg:object-cover rounded-lg" />
                </picture>
            </div>
